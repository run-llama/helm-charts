...
| `frontend.image.tag`                                  | Frontend Image tag                                                                                                | `0.1.37`                         |
...
| `backend.image.tag`                                  | Backend Image tag                                                                                                 | `0.1.37`                        |
...
| `jobsService.image.tag`                                  | JobsService Image tag                                                                                             | `0.1.37`                             |
...
| `jobsWorker.image.tag`                                  | JobsWorker Image tag                                                                                              | `0.1.37`                            |
...
| `llamaParse.image.tag`                                  | LlamaParse Image tag                                                        | `0.1.37`                           |
...
| `llamaParseOcr.image.tag`                                  | LlamaParseOcr Image tag                                                                     | `0.1.37`                               |
...
| `usage.image.tag`                                  | Usage Image tag                                                                                                   | `0.1.37`                      |
