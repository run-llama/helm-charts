...
| `frontend.image.tag`                                  | Frontend Image tag                                                                                                | `0.1.24`                         |
...
| `backend.image.tag`                                  | Backend Image tag                                                                                                 | `0.1.24`                        |
...
| `jobsService.image.tag`                                  | JobsService Image tag                                                                                             | `0.1.24`                             |
...
| `jobsWorker.image.tag`                                  | JobsWorker Image tag                                                                                              | `0.1.24`                            |
...
| `llamaParse.image.tag`                                  | LlamaParse Image tag                                                        | `0.1.24`                           |
...
| `llamaParseOcr.image.tag`                                  | LlamaParseOcr Image tag                                                                     | `0.1.24`                               |
...
| `usage.image.tag`                                  | Usage Image tag                                                                                                   | `0.1.24`                      |
