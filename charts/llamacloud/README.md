...
| `frontend.image.tag`                                   | Frontend Image tag                                                                                                | `0.1.45`                         |
...
| `backend.image.tag`                                   | Backend Image tag                                                                                                 | `0.1.45`                        |
...
| `jobsService.image.tag`                                   | JobsService Image tag                                                                                             | `0.1.45`                             |
...
| `jobsWorker.image.tag`                                   | JobsWorker Image tag                                                                                              | `0.1.45`                            |
...
| `llamaParse.image.tag`                                   | LlamaParse Image tag                                                                      | `0.1.45`                           |
...
| `llamaParseOcr.image.tag`                                   | LlamaParseOcr Image tag                                                                     | `0.1.45`                               |
...
| `usage.image.tag`                                   | Usage Image tag                                                                                                   | `0.1.45`                      |
