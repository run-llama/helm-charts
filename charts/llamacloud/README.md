...
| `frontend.image.tag`                                  | Frontend Image tag                                                                                                | `0.1.12`                         |
...
| `backend.image.tag`                                  | Backend Image tag                                                                                                 | `0.1.12`                        |
...
| `jobsService.image.tag`                                  | JobsService Image tag                                                                                             | `0.1.12`                             |
...
| `jobsWorker.image.tag`                                  | JobsWorker Image tag                                                                                              | `0.1.12`                            |
...
| `llamaParse.image.tag`                                  | LlamaParse Image tag                                                        | `0.1.12`                           |
...
| `llamaParseOcr.image.tag`                                  | LlamaParseOcr Image tag                                                                     | `0.1.12`                               |
...
| `usage.image.tag`                                  | Usage Image tag                                                                                                   | `0.1.12`                      |
