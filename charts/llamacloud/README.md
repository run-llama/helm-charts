...
| `frontend.image.tag`                                   | Frontend Image tag                                                                                                | `0.3.4`                          |
...
| `backend.config.llamaExtractMultimodalModel`          | LlamaExtract multimodal model (gemini-2.0-flash-001, gemini-2.5-pro, openai-gpt-4-1)                              | `gemini-2.0-flash-001`          |
...
| `backend.image.tag`                                   | Backend Image tag                                                                                                 | `0.3.4`                         |
...
| `jobsService.config.openAiApiKey`                         | OpenAI API key                                                                                                    | `""`                                 |
| `jobsService.config.existingOpenAiApiKeySecretName`       | Name of the existing secret to use for the OpenAI API key                                                         | `""`                                 |
| `jobsService.config.azureOpenAi.enabled`                  | Enable Azure OpenAI for jobsService                                                                               | `false`                              |
| `jobsService.config.azureOpenAi.existingSecret`           | Name of the existing secret to use for the Azure OpenAI API key                                                   | `""`                                 |
| `jobsService.config.azureOpenAi.key`                      | Azure OpenAI API key                                                                                              | `""`                                 |
| `jobsService.config.azureOpenAi.endpoint`                 | Azure OpenAI endpoint                                                                                             | `""`                                 |
| `jobsService.config.azureOpenAi.deploymentName`           | Azure OpenAI deployment                                                                                           | `""`                                 |
| `jobsService.config.azureOpenAi.apiVersion`               | Azure OpenAI API version                                                                                          | `""`                                 |
| `jobsService.config.anthropicApiKey`                      | Anthropic API key                                                                                                 | `""`                                 |
| `jobsService.config.existingAnthropicApiKeySecret`        | Name of the existing secret to use for the Anthropic API key                                                      | `""`                                 |
| `jobsService.config.geminiApiKey`                         | Google Gemini API key                                                                                             | `""`                                 |
| `jobsService.config.existingGeminiApiKeySecret`           | Name of the existing secret to use for the Google Gemini API key                                                  | `""`                                 |
| `jobsService.config.awsBedrock.enabled`                   | Enable AWS Bedrock for jobsService                                                                                | `false`                              |
| `jobsService.config.awsBedrock.existingSecret`            | Name of the existing secret to use for the AWS Bedrock API key                                                    | `""`                                 |
| `jobsService.config.awsBedrock.region`                    | AWS Bedrock region                                                                                                | `""`                                 |
| `jobsService.config.awsBedrock.accessKeyId`               | AWS Bedrock access key ID                                                                                         | `""`                                 |
| `jobsService.config.awsBedrock.secretAccessKey`           | AWS Bedrock secret access key                                                                                     | `""`                                 |
...
| `jobsService.image.tag`                                   | JobsService Image tag                                                                                             | `0.3.4`                              |
...
| `jobsWorker.image.tag`                                   | JobsWorker Image tag                                                                                              | `0.3.4`                             |
...
| `llamaParse.image.tag`                                   | LlamaParse Image tag                                                                      | `0.3.4`                            |
...
| `llamaParseOcr.image.tag`                                   | LlamaParseOcr Image tag                                                                     | `0.3.4`                                |
...
| `usage.image.tag`                                   | Usage Image tag                                                                                                   | `0.3.4`                       |
