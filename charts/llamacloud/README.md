...
| `frontend.image.tag`                                  | Frontend Image tag                                                                                                | `0.1.23`                         |
...
| `backend.config.qdrant.enabled`                      | Enable fully managed QDRANT Data-Sink on backend                                                                  | `false`                         |
...
| `backend.image.tag`                                  | Backend Image tag                                                                                                 | `0.1.23`                        |
...
| `jobsService.image.tag`                                  | JobsService Image tag                                                                                             | `0.1.23`                             |
...
| `jobsWorker.image.tag`                                  | JobsWorker Image tag                                                                                              | `0.1.23`                            |
...
| `llamaParse.image.tag`                                  | LlamaParse Image tag                                                        | `0.1.23`                           |
...
| `llamaParseOcr.image.tag`                                  | LlamaParseOcr Image tag                                                                     | `0.1.23`                               |
...
| `usage.image.tag`                                  | Usage Image tag                                                                                                   | `0.1.23`                      |
