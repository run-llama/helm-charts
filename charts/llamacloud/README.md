...
| `frontend.image.tag`                                  | Frontend Image tag                                                                                                | `0.1.20`                         |
...
| `backend.image.tag`                                  | Backend Image tag                                                                                                 | `0.1.20`                        |
...
| `jobsService.image.tag`                                  | JobsService Image tag                                                                                             | `0.1.20`                             |
...
| `jobsWorker.image.tag`                                  | JobsWorker Image tag                                                                                              | `0.1.20`                            |
...
| `llamaParse.image.tag`                                  | LlamaParse Image tag                                                        | `0.1.20`                           |
...
| `llamaParseOcr.image.tag`                                  | LlamaParseOcr Image tag                                                                     | `0.1.20`                               |
...
| `usage.image.tag`                                  | Usage Image tag                                                                                                   | `0.1.20`                      |
