...
| `frontend.image.tag`                                   | Frontend Image tag                                                                                                | `0.1.51`                         |
...
| `backend.image.tag`                                   | Backend Image tag                                                                                                 | `0.1.51`                        |
...
| `jobsService.image.tag`                                   | JobsService Image tag                                                                                             | `0.1.51`                             |
...
| `jobsWorker.image.tag`                                   | JobsWorker Image tag                                                                                              | `0.1.51`                            |
...
| `llamaParse.image.tag`                                   | LlamaParse Image tag                                                                      | `0.1.51`                           |
...
| `llamaParseOcr.image.tag`                                   | LlamaParseOcr Image tag                                                                     | `0.1.51`                               |
...
| `usage.image.tag`                                   | Usage Image tag                                                                                                   | `0.1.51`                      |
