...
| `frontend.image.tag`                                  | Frontend Image tag                                                                                                | `0.1.17`                         |
| `frontend.image.pullPolicy`                           | Frontend Image pull policy                                                                                        | `IfNotPresent`                   |
| `frontend.service.type`                               | Frontend Service type                                                                                             | `ClusterIP`                      |
| `frontend.service.port`                               | Frontend Service port                                                                                             | `3000`                           |
| `frontend.ingress.enabled`                            | Enable ingress for the Frontend Deployment                                                                        | `false`                          |
| `frontend.ingress.labels`                             | Labels to add to the ingress                                                                                      | `{}`                             |
| `frontend.ingress.annotations`                        | Annotations to add to the ingress                                                                                 | `{}`                             |
| `frontend.ingress.ingressClassName`                   | Ingress class name                                                                                                | `""`                             |
| `frontend.ingress.hostName`                           | Ingress host name                                                                                                 | `""`                             |
| `frontend.ingress.extraHosts`                         | Additional hosts to add to the ingress                                                                            | `[]`                             |
...
| `backend.image.tag`                                  | Backend Image tag                                                                                                 | `0.1.17`                        |
...
| `jobsService.image.tag`                                  | JobsService Image tag                                                                                             | `0.1.17`                             |
...
| `jobsWorker.image.tag`                                  | JobsWorker Image tag                                                                                              | `0.1.17`                            |
...
| `llamaParse.image.tag`                                  | LlamaParse Image tag                                                        | `0.1.17`                           |
...
| `llamaParseOcr.image.tag`                                  | LlamaParseOcr Image tag                                                                     | `0.1.17`                               |
...
| `usage.image.tag`                                  | Usage Image tag                                                                                                   | `0.1.17`                      |
