...
| `frontend.image.tag`                                  | Frontend Image tag                                                                                                | `0.1.5`                          |
...
| `backend.image.tag`                                  | Backend Image tag                                                                                                 | `0.1.5`                         |
...
| `jobsService.image.tag`                                  | JobsService Image tag                                                                                             | `0.1.5`                              |
...
| `jobsWorker.image.tag`                                  | JobsWorker Image tag                                                                                              | `0.1.5`                             |
...
| `llamaParse.image.tag`                                  | LlamaParse Image tag                                                        | `0.1.5`                            |
...
| `llamaParseOcr.image.tag`                                  | LlamaParseOcr Image tag                                                                     | `0.1.5`                                |
...
| `usage.image.tag`                                  | Usage Image tag                                                                                                   | `0.1.5`                       |
